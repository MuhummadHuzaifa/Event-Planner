  ...
  async function getAllEvents() {
    try {
      ...
      querySnapshot.forEach((doc) => {
        ...
        />
        <div id="discription" class="p-4">
          <h2 id="title" class="text-xl font-bold mb-2">${title}</h2>
          <p class="text-gray-600 mb-2 text-white">Time: ${date}, ${time}</p>
          <p class="text-gray-600 mb-2 text-white">Creator: ${createdByEmail}</p>
          <p class="text-gray-600 mb-2  text-white">Location: ${location}</p>
